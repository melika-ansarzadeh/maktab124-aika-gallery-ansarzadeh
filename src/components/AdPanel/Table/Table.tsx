            ...
            {paginatedData.map((row, i) => (
              ...
              >
                {columns.map(col => (
                  <td
                    key={col.key}
                    className="py-4 px-1 text-xs font-medium text-center whitespace-nowrap overflow-hidden text-ellipsis max-w-[200px] transition-all duration-200"
                ...
                <td className="py-4 px-1 text-center whitespace-nowrap">
                  <div className="flex justify-center items-center gap-3">
                    <button className="hover:text-blue-600 text-lg transition-all duration-200">
                      <AiOutlineEdit />
                    </button>
                    <button
