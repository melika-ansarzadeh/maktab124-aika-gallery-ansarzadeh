    ...
    <div className="w-full px-4 py-2 font-sahel">
      ...
      <div className="flex justify-between items-center my-5">
        ...
        <nav className="flex justify-between text-sm items-center gap-10">
          <Link href="/products" className="relative inline-block group">
            <span className="relative z-10">{headerlocalization.products}</span>
          ...
          >
            <span className="relative z-10"> {headerlocalization.brands}</span>
            <span className="absolute right-0 bottom-0 h-[2px] w-0 bg-custom-400 transition-all duration-300 group-hover:w-full group-hover:left-0"></span>
          </Link>
          <Link
            href="/about"
            className="relative inline-block group text-gray-800"
          >
            <span className="relative z-10"> {headerlocalization.aboutUs}</span>
            <span className="absolute right-0 bottom-0 h-[2px] w-0 bg-custom-400 transition-all duration-300 group-hover:w-full group-hover:left-0"></span>
          </Link>
          <Link
            href="/contact"
            className="relative inline-block group text-gray-800"
          >
            <span className="relative z-10"> {headerlocalization.callUs}</span>
            <span className="absolute right-0 bottom-0 h-[2px] w-0 bg-custom-400 transition-all duration-300 group-hover:w-full group-hover:left-0"></span>
          </Link>
          <Link
            href="/blogs"
